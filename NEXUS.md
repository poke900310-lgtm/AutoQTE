...
scene from a cancelled one, and a few scene director graphs do more than hand out
a prompt, so an auto-completed scene is not always something you can take back.

Use it at your own risk. I can't undo a bugged save or a story outcome you didn't
want, and the mod comes with no warranty - see `LICENSE.txt`.
