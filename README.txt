================================================================================
AutoQTE v1.0.3  -  The Blood of Dawnwalker
...
MOD MANAGER
    ...
    and deploy. a mod manager strips the Data folder and deploys into the right place.
...
UNINSTALL
    Remove it in a mod manager and deploy, or delete the Mods\AutoQTE folder. That
...
prefixed [Lua] [AutoQTE].
  ...
  "AutoQTE v1.0.3 loaded (0 blocklist patterns)"
